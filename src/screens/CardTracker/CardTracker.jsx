...
export const CardTracker = ({isVisible, onClose }) => {
   
  const slideInClass = isVisible ? 'translate-x-0' : 'translate-x-full';

  return (
    <div className={`fixed inset-0 flex justify-center items-center bg-[#131313] bg-opacity-1 z-50 transition-transform transition-all duration-700 transform ${slideInClass}`}>
          ...
          <div className="flex flex-col items-start gap-[16px] relative self-stretch w-full flex-[0_0_auto]">
            ...
            <div className="flex items-center gap-[16px] px-0 py-[4px] relative self-stretch w-full flex-[0_0_auto]">
              <div className="flex items-start gap-[16px] relative flex-1 grow">
                ...
                <div className="flex flex-col items-start gap-[8px] relative flex-1 grow">
                  <p className="self-stretch mt-[-1.00px] font-[number:var(--body-medium-high-emphasis-font-weight)] text-[color:var(--borderneutralprimary)] text-[length:var(--body-medium-high-emphasis-font-size)] tracking-[var(--body-medium-high-emphasis-letter-spacing)] leading-[var(--body-medium-high-emphasis-line-height)] relative [font-family:var(--body-medium-high-emphasis-font-family)] [font-style:var(--body-medium-high-emphasis-font-style)]">
